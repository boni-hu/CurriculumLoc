...
class TerraDataset(Dataset):
    def __init__(
            ...
            scene_info_path='/home/a409/users/huboni/Projects/dataset/TerraTrack/process_output_query_ref_500',
            base_path='/home/a409/users/huboni/Projects/dataset/TerraTrack',
            train=True,
            preprocessing=None,
            min_overlap_ratio=.5,
            max_overlap_ratio=1,
    ...
    def recover_pair(self, pair_metadata):
        ...
        with h5py.File(depth_path1, 'r') as hdf5_file:
            depth1 = np.array(hdf5_file['/depth'])   # FIXME
        # print(np.min(depth1))
        ...
        # make sure image and depth have same weight and height
        assert(image1.shape[0] == depth1.shape[0] and image1.shape[1] == depth1.shape[1])
        assert(image1.shape[0]>100)
    ...
    def __getitem__(self, idx):
        ...
        # if use model vit ignore preprocess_image
